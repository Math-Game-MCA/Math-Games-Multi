App.controller('DuplicateRuleController', [ '$scope', 'Restangular', '$rootScope', '$state', '$stateParams', 'flash', function($scope, Restangular, $rootScope, $state, $stateParams, flash) {
	'use strict';
	...
	function rules() {		
		Restangular.one('update-rules', $stateParams.accountId).get({ruleId: $stateParams.ruleId}).then(function(data){
			...
			_temp.ruleName = initial_data.data.ruleName + ' Duplicate';
